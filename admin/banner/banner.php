                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = mysqli_fetch_array($result)) {
                                                ...
                                                $id2 = $row['bannereId'];
                                                $sql2 = "SELECT bannerImage FROM banners
            WHERE bannereId=$id2";
                                        ...
                                        ?>
                                                <tr>
                                                    <?php
                                                    $button2 = '<form method="post" ><input type="hidden" name="delete_id" value="' . $row['bannereId'] . '"><input type="submit" class="btn btn-icon" value=""></form><i ></i>';
                                                    ?>
                                                    <td><?php echo $row['bannereId']; ?></td>
                                                   
                                                   <?php echo "<td>
 
 <img src=\"Images/{$file["bannerImage"]}\" height=\"80px\" width=\"80px;\">
 
 </td>"; ?>
                                                    <td><?php echo "<a type='button' class='btn btn-icon btn-lg' href='reviewdata.php?id=$row[customerId]'>" ?><i class=" mdi mdi-lead-pencil "></i></td>
                                                    <td><?php echo "<a type='button' class='btn btn-icon btn-lg' href='banner.php?id=$row[bannereId]'>" ?><i class="mdi mdi-delete-forever "></i></td>
...
if(isset($_GET['id'])){
    $bannID = $_GET['id'];
    $sql_delete = "DELETE FROM banners WHERE bannereId = $bannID";        
