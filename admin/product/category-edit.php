                  ...
                  <div class="card-body">
                      ...
                      <form id="submit_form">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="categoryId" name="categoryId" value="<?php echo $id?>" hidden>
                        </div>
                          <div class="form-group">
                          ...
                          <div class="form-group" id="submit_form">
                              ...
                              <input type="description" class="form-control" id="description" name="description" value="<?php echo $desc?>">
                          </div>
