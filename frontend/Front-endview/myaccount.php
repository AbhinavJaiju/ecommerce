  ...
  <div class="row content">
    <div class="col-sm-3 sidenav">
      ...
      <ul class="nav nav-pills nav-stacked"style="margin-top:4%;padding: 1px;">
        ...
        echo
        '<a href="http://localhost/ecommerce/frontend/Front-endview/editprofile.php?id='.$_SESSION["id"].'">Manage profile</a></li>';
        ?>
        <?php
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="footer__copyright__text">
                    <p>Copyright &copy; <script>document.write(new Date().getFullYear());</script> All rights reserved<i class="fa fa-heart"> </p>
                </div>
                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </div>
        </div>
